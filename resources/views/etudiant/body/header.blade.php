        ...
        <nav class="navbar navbar-expand">
            <div class="collapse navbar-collapse justify-content-between">
                ...
                <ul class="navbar-nav header-right main-notification" style="color:white;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"style="color: white;font-size:20px;" href="{{url('/sech')}}"> <i class="fa fa-search">{{ __('') }}</i></a>
                        </li>
                        <li class="nav-item">
                        <a class="nav-link"style="color: white;font-size:20px;" href="{{ route('jobs.create') }}"> <i class="fa fa-building">{{ __('') }}</i></a>
                        </li>
                        <li class="nav-item">
                        <a class="nav-link"style="color: white;font-size:20px;" href="{{ route('messages.create') }}"> <i class="fa fa-comments">{{ __('') }}</i></a>
                        </li>
